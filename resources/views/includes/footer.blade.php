<!-- global footer-->
<!-- https://stijl.kuleuven.be/2016/includes/footer.nl.inc -->
<footer class="global-footer noindex hidden-print">


    <div class="bottom-footer">
        <div class="container footer-padding-bottom">
            <div class="legal">
                <a href="https://www.kuleuven.be/kuleuven" class="logo"
                   title="KU Leuven"><img class="logo-img" alt="logo"
                                          src="https://stijl.kuleuven.be/2016/img/svg/logo.svg" width="107" height="38" /></a>
                <ul>
                    <li>2019 &copy; KU&nbsp;Leuven</li>
                    <li><a href="https://www.kuleuven.be/kuleuven/disclaimer.html">Disclaimer</a>
                    </li>
                    <li><a href="https://admin.kuleuven.be/icts/cookiebeleid/">Cookiebeleid</a>
                    </li>
                </ul>
            </div>
            <div class="share">
                ...
                <a href="https://www.facebook.com/KULeuven">
                    <svg role="img" width="30" height="30" viewBox="0 0 1792 1792">
                        ...
                        <path
                                d="M1376 128q119 0 203.5 84.5T1664 416v960q0 119-84.5 203.5T1376 1664h-188v-595h199l30-232h-229V689q0-56 23.5-84t91.5-28l122-1V369q-63-9-178-9-136 0-217.5 80T948 666v171H748v232h200v595H416q-119 0-203.5-84.5T128 1376V416q0-119 84.5-203.5T416 128h960z"></path>
                    </svg>
                </a>
...
@yield('footer-script-2')
<script src="{{ asset('js/main.js') }}"></script>
<script src="//stijl.kuleuven.be/2016/release/latest/js/all.min.js"></script>
<script src="{{ asset('bootstrap-datetimepicker/js/bootstrap-datetimepicker.js') }}"></script>
<script type="text/javascript" src="{{ asset('bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.nl.js') }}" charset="UTF-8"></script>
...
<script type="text/javascript">
    tinymce.init({
        ...
        statusbar: false,
        plugins: "link advlist lists",
        branding: false,
        language: document.getElementById('language').innerHTML.trim() === "" ? "nl" : document.getElementById('language').innerHTML.trim(),
        content_css: [
